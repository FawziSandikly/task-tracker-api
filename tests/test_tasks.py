...
def test_invalid_transition_done_to_in_progress(client: TestClient):
    """Test invalid transition: done -> in_progress."""
    create_response = client.post(
        "/api/v1/tasks/",
        json={
            "title": "Task",
...
def test_invalid_transition_done_to_todo(client: TestClient):
    """Test invalid transition: done -> todo."""
    create_response = client.post(
        "/api/v1/tasks/",
        json={
            "title": "Task",
...
def test_invalid_transition_in_progress_to_todo(client: TestClient):
    """Test invalid transition: in_progress -> todo."""
    create_response = client.post(
        "/api/v1/tasks/",
        json={
            "title": "Task",
...
def test_update_preserves_status_when_omitted(client: TestClient):
    """Test status remains unchanged when omitted from update."""
    create_response = client.post(
        "/api/v1/tasks/",
        json={
            "title": "Task",
